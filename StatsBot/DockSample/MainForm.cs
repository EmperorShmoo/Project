...
namespace DockSample
{
    public partial class MainForm : Form
    {
        ...
        private KeyDataSet_Tool m_keyDataSet;
        private LogWindow m_logWindow;

        private Study activeStudy;   //Active study to work on
        ...
        private DataView CreateNewDataView()
        {
            DataView dataView = new DataView();

            int count = 1;
            string text = "Data View" + count.ToString();
            while (FindDocument(text) != null)
            {
                count++;
                text = "Data View" + count.ToString();
            }
            dataView.Text = text;
            return dataView;
        }
        ...
        private IDockContent GetContentFromPersistString(string persistString)
        {
            if (persistString == typeof(DummySolutionExplorer).ToString())
                ...
                return m_taskList;
            else if (persistString == typeof(KeyDataSet_Tool).ToString())
                return m_keyDataSet;
        ...
        private void CloseAllContents()
        {
            ...
            m_keyDataSet.DockPanel = null;
            m_logWindow.DockPanel = null;
        ...
        private void toolStripButtonKeyDataset_Click(object sender, EventArgs e)
        {
            m_logWindow.Show(dockPanel);
            //m_keyDataSet.Show(dockPanel);
        }
        ...
        private void toolStripButtonNewKeyDataSet_Click(object sender, EventArgs e)
        {
            KeyDataSet_Dynamic dataset = CreateKeyDataSet(activeSession);
            if (dockPanel.DocumentStyle == DocumentStyle.SystemMdi)
            {
                dataset.MdiParent = this;
                dataset.Show();
            }
            else
            {
                dataset.Show(dockPanel);
            }
        }
        ...
        private void menuItemLayoutByCode_Click(object sender, System.EventArgs e)
        {
            ...
            m_logWindow.Show(dockPanel, DockState.DockRight);
            //m_keyDataSet.Show(dockPanel, DockState.DockRight);
        ...
        private void CreateStandardControls()
        {
            ...
            m_keyDataSet = new KeyDataSet_Tool();
            m_logWindow = new LogWindow();
            Instance.SASLogWindow = m_logWindow;
        }
        ...
        public void UpdateStatusMsg(string newStatusMsg)
        {
            statusMsg.Text = newStatusMsg;
        }

        private void clearDatasetsToolStripMenuItem_Click(object sender, EventArgs e)
        {
            //TODO
        }
        ...
        private void menuNewStudy_Click(object sender, EventArgs e)
        {
            StudySelection formStudySelection = new StudySelection();
            formStudySelection.ShowDialog();
            activeStudy = Instance.study;
        }
